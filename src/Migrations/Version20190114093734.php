 ...
 */
final class Version20190114093734 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE poll ADD user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_84BCFA45A76ED395 ON poll');
        $this->addSql('ALTER TABLE poll DROP user_id');
    }
}
